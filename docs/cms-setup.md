...
> 2026-09-06 狀態註記：本文為早期建置說明，不是目前部署驗收紀錄。前台、登入及後台已於 6 月恢復；本次確認公開頁面與 `ce22a89` 一致。現行首頁以資源目錄為主，本文的章節、小卡與靜態回退描述包含舊版架構。操作與角色權限請搭配 `_系統/核對清單/20260619_後台操作與權限邊界.md` 閱讀；本次核對見 `docs/project-status-2026-09-06.md`。不要因本文件而重新初始化或覆蓋既有 Sheets 資料。
